...
- [ ] Describe Middleware?
  A function that exists somewhere along the express server "pipline" that receives requests, and can modify them or perform side effects, and either respond to them directly, or pass them along to the next function in line.

- [ ] Describe a Resource?
  Any peice of data that the server has, that it can share with the client.

- [ ] What can the API return to help clients know if a request was successful?
  Status codes.  A code in the 200-range usually indicates a success

- [ ] How can we partition our application into sub-applications?
  Routers and middleware.  Both can be used to break up a complex and monolithic application into reusable components that are much easier to test, understand, and compose into new uses with less code repetition.
